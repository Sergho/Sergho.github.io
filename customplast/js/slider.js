...
class ItcSlider {
  static CLASS_CONTROL = 'js-slider-control';
  static CLASS_CONTROL_HIDE = 'js-slider-control_hide';
  static CLASS_ITEM_ACTIVE = 'js-slider-slide_active';
  static CLASS_INDICATOR_ACTIVE = 'active';
  static SEL_WRAPPER = '.js-slider-wrapper';
  static SEL_ITEM = '.js-slider-slide';
  static SEL_ITEMS = '.js-slider-slides';
  static SEL_PREV = '.js-slider-control[data-slide="prev"]';
  static SEL_NEXT = '.js-slider-control[data-slide="next"]';
  static SEL_INDICATOR = '.js-slider-dots>li';
  static TRANSITION_OFF = 'js-slider-disable-transition';
